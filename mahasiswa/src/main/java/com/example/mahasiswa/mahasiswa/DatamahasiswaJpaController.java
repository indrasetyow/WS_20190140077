...
import com.example.mahasiswa.mahasiswa.exceptions.NonexistentEntityException;
import com.example.mahasiswa.mahasiswa.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example.mahasiswa_mahasiswa_jar_0.0.1-SNAPSHOTPU");
